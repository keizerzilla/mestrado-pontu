...
def classif(ext_name, training_ft, training_cl, test_ft, test_cl):
    classifiers = [
...
def usage():
	print("Uso: <ext_name> <training_ft> <training_cl> <test_ft> <test_cl>\n")
...
def main():
	argc = len(sys.argv)
	if argc == 6:
		classif(sys.argv[1], sys.argv[2], sys.argv[3], sys.argv[4], sys.argv[5])
	else:
		usage()
