...
/**
 * \brief Cálculo completo dos momentos de legendre invariantes de uma nuvem
 * \param cloud A nuvem alvo
...
struct matrix* legendre_invariant_moments(struct cloud* cloud)
{
    ...
    real g200 = legendre_moment(2, 0, 0, cloud);
    real g020 = legendre_moment(0, 2, 0, cloud);
    real g002 = legendre_moment(0, 0, 2, cloud);
    real g110 = legendre_moment(1, 1, 0, cloud);
    real g101 = legendre_moment(1, 0, 1, cloud);
    real g011 = legendre_moment(0, 1, 1, cloud);
