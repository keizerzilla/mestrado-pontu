...
cloud_xyz=" ../datasets/dump/bs000_CR_RD_0.xyz "
graph_xyz=" ../datasets/dump/graph_bs000_CR_RD_0.xyz "

cloud_pcd=" ../datasets/dump/bs000_CR_RD_0.pcd "
graph_pcd=" ../datasets/dump/graph_bs000_CR_RD_0.pcd "
